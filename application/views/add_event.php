...
<body>
    ...
    <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Add Future Events</h1>
                         <?php
                            if($t==0)
                        {?>
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-12">
                        <form role = "form" method="post" action="<?php echo site_url("Welcome/Submit"); ?>">
                            <div class="form-group col-lg-6">
                                <label>Event Name : </label>
                                <input required class="form-control" name="eventname" placeholder="Enter Event Name">
                                <br>
                                <label>Date : </label>
                                <input required class="form-control" type="date" name="date" placeholder="Enter Date">
                                <br>
                                <label>Time : </label>
                                <input required  class="form-control" type="time" name="time" placeholder="Enter Time">
                                <br>
                                <label>Venue : </label>
                                <input required  class="form-control" name="place" placeholder="Enter Venue">
                                <br>
