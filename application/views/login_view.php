...
<div class="top-nav">
                ...
                <ul class="res">
                    <li><a href="<?php echo base_url(); ?>comp/index.html"><i class="glyphicon glyphicon-home"> </i>Home</a></li>
                    <li><a href="<?php echo base_url(); ?>comp/about.html"><i class="glyphicon glyphicon-user"> </i>About</a></li>                    
                    <li><a class="<?php echo base_url(); ?>comp/active" href="shortcodes.html"><i class="glyphicon glyphicon-list-alt"> </i>Short Codes</a></li>
                    <li><a href="<?php echo base_url(); ?>comp/blog.html"><i class="glyphicon glyphicon-picture"> </i>Blog</a></li>
                    <li><a href="<?php echo base_url(); ?>comp/contact.html"><i class="glyphicon glyphicon-envelope"> </i>Contact</a></li>
                </ul>
                <!-- script-for-menu -->
                             <script>
